...
3. 主 App 與 Widget 擴充確認勾選同一 App Group（`group.com.qinghe.calendar`）
...
2. 主 App 與 Widget 擴充勾選同一 App Group（`group.com.qinghe.calendar`）
...
### Bundle ID 與 App Group（目前值）

| 項目 | 值 |
|---|---|
| 主 App Bundle ID | `com.qinghe.calendar` |
| Widget 擴充 Bundle ID | `com.qinghe.calendar.widget` |
...
- [ ] 主 App + Widget 擴充均勾選同一 App Group（`group.com.qinghe.calendar`）
