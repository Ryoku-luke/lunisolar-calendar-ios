...
public enum EventType: String, Codable, CaseIterable, Identifiable, Sendable {
    ...
    public var uiLabel: String {
        switch self {
        case .schedule: return L10n.str("日程")
        case .reminder: return L10n.str("提醒")
        case .note:     return L10n.str("记事")
        }
    }
...
public enum RepeatRule: String, Codable, CaseIterable, Identifiable, Sendable {
    ...
    public var uiLabel: String { L10n.str(rawValue) }
...
public struct CalendarEvent: Identifiable, Codable, Sendable {
    ...
    public func occurs(on date: Date, cachedStartLunar: LunarDate? = nil) -> Bool {
        ...
        switch repeatRule {
        case .never:
            // P2 修复：跨午夜事件（23:30–00:30）应在起止两日都显示。
            //   旧逻辑 target == start 导致次日看不到延续。
