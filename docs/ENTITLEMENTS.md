...
|---|---|---|---|
| **App Groups** | 主 App 与 Widget Extension 共享数据快照 | ✅ | `group.com.lumingfeng.lunisolarcalendar` |
| **iCloud** | CloudKit 私有数据库同步 | ⚠️ 仅付费账号 | 勾选 CloudKit，Container ID：`iCloud.com.lumingfeng.lunisolarcalendar` |
...
<dict>
    ...
    <array>
        <string>group.com.lumingfeng.lunisolarcalendar</string>
    </array>
</dict>
</plist>
```
...
3. 创建 Container ID：`iCloud.com.lumingfeng.lunisolarcalendar`

### 2. Xcode 配置

1. 主 App Target → Signing & Capabilities → 添加 iCloud
2. 勾选 CloudKit → 选择 Container：`iCloud.com.lumingfeng.lunisolarcalendar`
...
let provider = RealCloudKitProvider(
    containerIdentifier: "iCloud.com.lumingfeng.lunisolarcalendar"
)
```
